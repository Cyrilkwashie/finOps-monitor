...
export const banks: Bank[] = [
  {
    id: 'fnb', name: 'Sierra Leone Commercial Bank', code: 'SLCB', country: 'SL', tier: 'tier1',
    logo: '/images/SLCB LOGO.png',
    ...
    operations: {
      SOD: {
        ...
        procedures: [
          proc('s1','System Health Check','completed',{ duration:120, startedAt:'2026-04-14T05:00:00Z', completedAt:'2026-04-14T05:02:00Z', seq:1, processId:'N0000000001SOD00001', processProc:'begin prc_system_health_check; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'Y' }),
          proc('s2','Database Connectivity Test','completed',{ duration:45, startedAt:'2026-04-14T05:02:00Z', completedAt:'2026-04-14T05:02:45Z', seq:2, processId:'N0000000001SOD00002', processProc:'begin prc_db_connectivity_test; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'Y' }),
          proc('s3','Core Banking Bootstrap','completed',{ duration:380, startedAt:'2026-04-14T05:03:00Z', completedAt:'2026-04-14T05:09:20Z', seq:3, processId:'N0000000001SOD00003', processProc:'begin prc_core_banking_bootstrap; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'Y' }),
          proc('s4','Account Balance Reconciliation','completed',{ duration:720, startedAt:'2026-04-14T05:09:20Z', completedAt:'2026-04-14T05:21:20Z', seq:4, processId:'N0000000001SOD00004', processProc:'begin prc_account_balance_recon; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'N' }),
          proc('s5','FX Rate Loader','completed',{ duration:60, startedAt:'2026-04-14T05:21:20Z', completedAt:'2026-04-14T05:22:20Z', seq:5, processId:'N0000000001SOD00005', processProc:'begin prc_fx_rate_loader; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'Y' }),
          proc('s6','Batch Queue Initialization','completed',{ duration:30, startedAt:'2026-04-14T05:22:20Z', completedAt:'2026-04-14T05:22:50Z', seq:6, processId:'N0000000001SOD00006', processProc:'begin prc_batch_queue_init; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'Y' }),
        ],
      },
      POD: {
        ...
        procedures: [
          proc('p1','Intraday Position Check','completed',{ duration:200, startedAt:'2026-04-14T14:00:00Z', completedAt:'2026-04-14T14:03:20Z', seq:1, processId:'N0000000001POD00001', processProc:'begin prc_intraday_position_chk; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'N' }),
          proc('p2','Liquidity Buffer Validation','completed',{ duration:180, startedAt:'2026-04-14T14:03:20Z', completedAt:'2026-04-14T14:06:20Z', seq:2, processId:'N0000000001POD00002', processProc:'begin prc_liquidity_buffer_val; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'N' }),
          proc('p3','Pending Transactions Sweep','running',{ progress:61, elapsed:5600, avgDuration:200, startedAt:'2026-04-14T13:07:00Z', seq:3, processId:'N0000000001POD00003', processProc:'begin prc_pending_txn_sweep; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'N' }),
          proc('p4','Regulatory Report Prep','not_started',{ seq:4, processId:'N0000000001POD00004', processProc:'begin prc_regulatory_rpt_prep; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'N' }),
          proc('p5','Risk Exposure Snapshot','not_started',{ seq:5, processId:'N0000000001POD00005', processProc:'begin prc_risk_exposure_snapshot; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'N' }),
        ],
      },
  ...
  {
    id: 'ctb', name: 'SIB', code: 'SIB', country: 'SL', tier: 'tier1',
    logo: '/images/SIB LOGO.png',
    ...
    operations: {
      SOD: {
        ...
        procedures: [
          proc('s1','System Health Check','completed',{ duration:95, startedAt:'2026-04-14T05:10:00Z', completedAt:'2026-04-14T05:11:35Z', seq:1, processId:'N0000000002SOD00001', processProc:'begin prc_system_health_check; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'Y' }),
          proc('s2','Database Connectivity Test','completed',{ duration:52, startedAt:'2026-04-14T05:11:35Z', completedAt:'2026-04-14T05:12:27Z', seq:2, processId:'N0000000002SOD00002', processProc:'begin prc_db_connectivity_test; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'Y' }),
          proc('s3','Core Banking Bootstrap','completed',{ duration:410, startedAt:'2026-04-14T05:12:27Z', completedAt:'2026-04-14T05:19:17Z', seq:3, processId:'N0000000002SOD00003', processProc:'begin prc_core_banking_bootstrap; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'Y' }),
          proc('s4','Account Balance Reconciliation','completed',{ duration:650, startedAt:'2026-04-14T05:19:17Z', completedAt:'2026-04-14T05:30:07Z', seq:4, processId:'N0000000002SOD00004', processProc:'begin prc_account_balance_recon; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'N' }),
          proc('s5','FX Rate Loader','completed',{ duration:55, startedAt:'2026-04-14T05:30:07Z', completedAt:'2026-04-14T05:31:02Z', seq:5, processId:'N0000000002SOD00005', processProc:'begin prc_fx_rate_loader; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'Y' }),
        ],
      },
      POD: {
        ...
        procedures: [
          proc('p1','Intraday Position Check','completed',{ duration:190, startedAt:'2026-04-14T14:05:00Z', completedAt:'2026-04-14T14:08:10Z', seq:1, processId:'N0000000002POD00001', processProc:'begin prc_intraday_position_chk; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'N' }),
          proc('p2','Liquidity Buffer Validation','completed',{ duration:175, startedAt:'2026-04-14T14:08:10Z', completedAt:'2026-04-14T14:11:05Z', seq:2, processId:'N0000000002POD00002', processProc:'begin prc_liquidity_buffer_val; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'N' }),
          proc('p3','Pending Transactions Sweep','completed',{ duration:320, startedAt:'2026-04-14T14:11:05Z', completedAt:'2026-04-14T14:16:25Z', seq:3, processId:'N0000000002POD00003', processProc:'begin prc_pending_txn_sweep; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'N' }),
          proc('p4','Regulatory Report Prep','completed',{ duration:280, startedAt:'2026-04-14T14:16:25Z', completedAt:'2026-04-14T14:21:05Z', seq:4, processId:'N0000000002POD00004', processProc:'begin prc_regulatory_rpt_prep; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'N' }),
        ],
      },
      EOD: {
        ...
        procedures: [
          proc('e1','End of Day Position Lock','completed',{ duration:300, startedAt:'2026-04-14T17:00:00Z', completedAt:'2026-04-14T17:05:00Z', seq:1, processId:'N0000000002EOD00001', processProc:'begin prc_eod_position_lock; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'Y' }),
          proc('e2','Overnight Batch Trigger','running',{ progress:23, elapsed:2580, avgDuration:180, startedAt:'2026-04-14T17:05:00Z', seq:2, processId:'N0000000002EOD00002', processProc:'begin prc_overnight_batch_trigger; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'Y' }),
          proc('e3','Statement Generation','not_started',{ seq:3, processId:'N0000000002EOD00003', processProc:'begin prc_statement_generation; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'N' }),
          proc('e4','GL Reconciliation','not_started',{ seq:4, processId:'N0000000002EOD00004', processProc:'begin prc_gl_reconciliation; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'Y' }),
          proc('e5','Audit Log Flush','not_started',{ seq:5, processId:'N0000000002EOD00005', processProc:'begin prc_audit_log_flush; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'Y' }),
        ],
      },
    },
  },
  {
    id: 'hcb', name: 'Universal Trust Bank', code: 'UTB', country: 'GH', tier: 'tier2',
    ...
    operations: {
      SOD: {
        ...
        procedures: [
          proc('s1','System Health Check','completed',{ duration:110, startedAt:'2026-04-14T05:15:00Z', completedAt:'2026-04-14T05:16:50Z', seq:1, processId:'N0000000003SOD00001', processProc:'begin prc_system_health_check; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'Y' }),
          proc('s2','Database Connectivity Test','failed',{ logs:['Connection timeout after 30s','Retry 1 failed','Retry 2 failed'], seq:2, processId:'N0000000003SOD00002', processProc:'begin prc_db_connectivity_test; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'Y' }),
          proc('s3','Core Banking Bootstrap','not_started',{ seq:3, processId:'N0000000003SOD00003', processProc:'begin prc_core_banking_bootstrap; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'Y' }),
          proc('s4','Account Balance Reconciliation','not_started',{ seq:4, processId:'N0000000003SOD00004', processProc:'begin prc_account_balance_recon; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'N' }),
        ],
      },
  ...
  {
    id: 'mrb', name: 'Atwima Kwanwoma Urban Bank', code: 'AKUB', country: 'GH', tier: 'tier2',
    logo: '/images/akrb_logo2.png',
    ...
    operations: {
      SOD: {
        ...
        procedures: [
          proc('s1','System Health Check','completed',{ duration:105, startedAt:'2026-04-14T05:05:00Z', completedAt:'2026-04-14T05:06:45Z', seq:1, processId:'N0000000004SOD00001', processProc:'begin prc_system_health_check; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'Y' }),
          proc('s2','Database Connectivity Test','completed',{ duration:48, startedAt:'2026-04-14T05:06:45Z', completedAt:'2026-04-14T05:07:33Z', seq:2, processId:'N0000000004SOD00002', processProc:'begin prc_db_connectivity_test; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'Y' }),
          proc('s3','Core Banking Bootstrap','completed',{ duration:390, startedAt:'2026-04-14T05:07:33Z', completedAt:'2026-04-14T05:14:03Z', seq:3, processId:'N0000000004SOD00003', processProc:'begin prc_core_banking_bootstrap; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'Y' }),
          proc('s4','Account Balance Reconciliation','completed',{ duration:700, startedAt:'2026-04-14T05:14:03Z', completedAt:'2026-04-14T05:25:43Z', seq:4, processId:'N0000000004SOD00004', processProc:'begin prc_account_balance_recon; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'N' }),
          proc('s5','FX Rate Loader','completed',{ duration:58, startedAt:'2026-04-14T05:25:43Z', completedAt:'2026-04-14T05:26:41Z', seq:5, processId:'N0000000004SOD00005', processProc:'begin prc_fx_rate_loader; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'Y' }),
          proc('s6','Batch Queue Initialization','completed',{ duration:28, startedAt:'2026-04-14T05:26:41Z', completedAt:'2026-04-14T05:27:09Z', seq:6, processId:'N0000000004SOD00006', processProc:'begin prc_batch_queue_init; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'Y' }),
        ],
      },
      POD: {
        ...
        procedures: [
          proc('p1','Intraday Position Check','completed',{ duration:195, startedAt:'2026-04-14T14:10:00Z', completedAt:'2026-04-14T14:13:15Z', seq:1, processId:'N0000000004POD00001', processProc:'begin prc_intraday_position_chk; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'N' }),
          proc('p2','Liquidity Buffer Validation','running',{ progress:38, startedAt:'2026-04-14T14:13:00Z', seq:2, processId:'N0000000004POD00002', processProc:'begin prc_liquidity_buffer_val; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'N' }),
          proc('p3','Pending Transactions Sweep','not_started',{ seq:3, processId:'N0000000004POD00003', processProc:'begin prc_pending_txn_sweep; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'N' }),
          proc('p4','Regulatory Report Prep','not_started',{ seq:4, processId:'N0000000004POD00004', processProc:'begin prc_regulatory_rpt_prep; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'N' }),
        ],
      },
  ...
  {
    id: 'apb', name: 'Rokel Commercial Bank', code: 'RCB', country: 'SL', tier: 'tier3',
    logo: '/images/Rokel Bank logo.png',
  ...
  {
    id: 'bpsl', name: 'Best Point Savings and Loans', code: 'BPSL', country: 'GH', tier: 'tier3',
    logo: '/images/bestpoint logo.png',
    lastUpdated: '2026-04-14T07:30:00Z',
    operations: {
      SOD: {
        type: 'SOD', status: 'completed', progress: 100,
        startedAt: '2026-04-14T05:25:00Z', completedAt: '2026-04-14T05:58:00Z',
        initiatedBy: 'Kweku Andoh', procedureCount: 55, completedCount: 55,
        procedures: [
          proc('s1','System Health Check','completed',{ duration:88, startedAt:'2026-04-14T05:25:00Z', completedAt:'2026-04-14T05:26:28Z', seq:1, processId:'N0000000006SOD00001', processProc:'begin prc_system_health_check; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'Y' }),
          proc('s2','Database Connectivity Test','completed',{ duration:40, startedAt:'2026-04-14T05:26:28Z', completedAt:'2026-04-14T05:27:08Z', seq:2, processId:'N0000000006SOD00002', processProc:'begin prc_db_connectivity_test; commit; end;', enabled:'Y', transReq:'Z', exeOnWknd:'Y' }),
          proc('s3','Core Banking Bootstrap','completed',{ duration:360, startedAt:'2026-04-14T05:27:08Z', completedAt:'2026-04-14T05:33:08Z', seq:3, processId:'N0000000006SOD00003', processProc:'begin prc_core_banking_bootstrap; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'Y' }),
          proc('s4','Account Balance Reconciliation','completed',{ duration:680, startedAt:'2026-04-14T05:33:08Z', completedAt:'2026-04-14T05:44:28Z', seq:4, processId:'N0000000006SOD00004', processProc:'begin prc_account_balance_recon; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'N' }),
          proc('s5','FX Rate Loader','completed',{ duration:52, startedAt:'2026-04-14T05:44:28Z', completedAt:'2026-04-14T05:45:20Z', seq:5, processId:'N0000000006SOD00005', processProc:'begin prc_fx_rate_loader; commit; end;', enabled:'Y', transReq:'Y', exeOnWknd:'Y' }),
        ],
      },
      POD: { type: 'POD', status: 'pending', progress: 0, procedureCount: 38, completedCount: 0, procedures: [] },
      EOD: { type: 'EOD', status: 'not_started', progress: 0, procedureCount: 70, completedCount: 0, procedures: [] },
    },
  },
]
...
export const history: HistoryEntry[] = [
  ...
  // bpsl — Best Point Savings and Loans
  { date: '2026-04-14', bankId: 'bpsl', opType: 'SOD', status: 'completed', duration: 1980, proceduresRun: 55, proceduresFailed: 0, startedAt: '2026-04-14T05:25:00Z', completedAt: '2026-04-14T05:58:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-13', bankId: 'bpsl', opType: 'SOD', status: 'completed', duration: 1920, proceduresRun: 55, proceduresFailed: 0, startedAt: '2026-04-13T05:25:00Z', completedAt: '2026-04-13T05:57:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-13', bankId: 'bpsl', opType: 'POD', status: 'completed', duration: 1560, proceduresRun: 38, proceduresFailed: 0, startedAt: '2026-04-13T14:00:00Z', completedAt: '2026-04-13T14:26:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-13', bankId: 'bpsl', opType: 'EOD', status: 'completed', duration: 2880, proceduresRun: 70, proceduresFailed: 0, startedAt: '2026-04-13T17:00:00Z', completedAt: '2026-04-13T17:48:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-12', bankId: 'bpsl', opType: 'SOD', status: 'completed', duration: 1980, proceduresRun: 55, proceduresFailed: 0, startedAt: '2026-04-12T05:25:00Z', completedAt: '2026-04-12T05:58:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-12', bankId: 'bpsl', opType: 'POD', status: 'completed', duration: 1500, proceduresRun: 38, proceduresFailed: 0, startedAt: '2026-04-12T14:00:00Z', completedAt: '2026-04-12T14:25:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-12', bankId: 'bpsl', opType: 'EOD', status: 'completed', duration: 2940, proceduresRun: 70, proceduresFailed: 0, startedAt: '2026-04-12T17:00:00Z', completedAt: '2026-04-12T17:49:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-11', bankId: 'bpsl', opType: 'SOD', status: 'completed', duration: 1860, proceduresRun: 55, proceduresFailed: 0, startedAt: '2026-04-11T05:25:00Z', completedAt: '2026-04-11T05:56:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-11', bankId: 'bpsl', opType: 'POD', status: 'failed',    duration: 480,  proceduresRun: 12, proceduresFailed: 1, startedAt: '2026-04-11T14:00:00Z', completedAt: '2026-04-11T14:08:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-11', bankId: 'bpsl', opType: 'EOD', status: 'completed', duration: 2880, proceduresRun: 70, proceduresFailed: 0, startedAt: '2026-04-11T17:00:00Z', completedAt: '2026-04-11T17:48:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-10', bankId: 'bpsl', opType: 'SOD', status: 'completed', duration: 1920, proceduresRun: 55, proceduresFailed: 0, startedAt: '2026-04-10T05:25:00Z', completedAt: '2026-04-10T05:57:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-10', bankId: 'bpsl', opType: 'POD', status: 'completed', duration: 1540, proceduresRun: 38, proceduresFailed: 0, startedAt: '2026-04-10T14:00:00Z', completedAt: '2026-04-10T14:26:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-10', bankId: 'bpsl', opType: 'EOD', status: 'completed', duration: 2900, proceduresRun: 70, proceduresFailed: 0, startedAt: '2026-04-10T17:00:00Z', completedAt: '2026-04-10T17:48:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-09', bankId: 'bpsl', opType: 'SOD', status: 'completed', duration: 1960, proceduresRun: 55, proceduresFailed: 0, startedAt: '2026-04-09T05:25:00Z', completedAt: '2026-04-09T05:58:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-09', bankId: 'bpsl', opType: 'POD', status: 'completed', duration: 1520, proceduresRun: 38, proceduresFailed: 0, startedAt: '2026-04-09T14:00:00Z', completedAt: '2026-04-09T14:25:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-09', bankId: 'bpsl', opType: 'EOD', status: 'completed', duration: 2860, proceduresRun: 70, proceduresFailed: 0, startedAt: '2026-04-09T17:00:00Z', completedAt: '2026-04-09T17:48:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-08', bankId: 'bpsl', opType: 'SOD', status: 'completed', duration: 1940, proceduresRun: 55, proceduresFailed: 0, startedAt: '2026-04-08T05:25:00Z', completedAt: '2026-04-08T05:57:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-08', bankId: 'bpsl', opType: 'POD', status: 'completed', duration: 1560, proceduresRun: 38, proceduresFailed: 0, startedAt: '2026-04-08T14:00:00Z', completedAt: '2026-04-08T14:26:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-08', bankId: 'bpsl', opType: 'EOD', status: 'failed',    duration: 900,  proceduresRun: 25, proceduresFailed: 2, startedAt: '2026-04-08T17:00:00Z', completedAt: '2026-04-08T17:15:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-07', bankId: 'bpsl', opType: 'SOD', status: 'completed', duration: 1900, proceduresRun: 55, proceduresFailed: 0, startedAt: '2026-04-07T05:25:00Z', completedAt: '2026-04-07T05:57:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-07', bankId: 'bpsl', opType: 'POD', status: 'completed', duration: 1540, proceduresRun: 38, proceduresFailed: 0, startedAt: '2026-04-07T14:00:00Z', completedAt: '2026-04-07T14:26:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-07', bankId: 'bpsl', opType: 'EOD', status: 'completed', duration: 2920, proceduresRun: 70, proceduresFailed: 0, startedAt: '2026-04-07T17:00:00Z', completedAt: '2026-04-07T17:49:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-06', bankId: 'bpsl', opType: 'SOD', status: 'completed', duration: 1980, proceduresRun: 55, proceduresFailed: 0, startedAt: '2026-04-06T05:25:00Z', completedAt: '2026-04-06T05:58:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-06', bankId: 'bpsl', opType: 'POD', status: 'completed', duration: 1500, proceduresRun: 38, proceduresFailed: 0, startedAt: '2026-04-06T14:00:00Z', completedAt: '2026-04-06T14:25:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-06', bankId: 'bpsl', opType: 'EOD', status: 'completed', duration: 2880, proceduresRun: 70, proceduresFailed: 0, startedAt: '2026-04-06T17:00:00Z', completedAt: '2026-04-06T17:48:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-05', bankId: 'bpsl', opType: 'SOD', status: 'completed', duration: 1960, proceduresRun: 55, proceduresFailed: 0, startedAt: '2026-04-05T05:25:00Z', completedAt: '2026-04-05T05:58:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-05', bankId: 'bpsl', opType: 'POD', status: 'completed', duration: 1520, proceduresRun: 38, proceduresFailed: 0, startedAt: '2026-04-05T14:00:00Z', completedAt: '2026-04-05T14:25:00Z', initiatedBy: 'Kweku Andoh' },
  { date: '2026-04-05', bankId: 'bpsl', opType: 'EOD', status: 'completed', duration: 2900, proceduresRun: 70, proceduresFailed: 0, startedAt: '2026-04-05T17:00:00Z', completedAt: '2026-04-05T17:48:00Z', initiatedBy: 'Kweku Andoh' },
]
